...
Want to explore how the app works without uploading your own PDFs?

### 📥 Sample Input Files  
📁 **[Download Sample PDFs](https://drive.google.com/drive/folders/1ZAaRl_O3Z8AkFutNEWLEFRWrXE1PBcrD?usp=sharing)**  
Educational documents used to generate flashcards.

### 📤 Sample Output Files  
📁 **[View Flashcard Outputs](https://drive.google.com/drive/folders/1SB1Y95u3R7jVguV_YR81gCx39Th-gQfK?usp=sharing)**  
Includes `.json` and `.txt` files with AI-generated Q&A flashcards.
